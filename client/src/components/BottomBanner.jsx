...
const BottomBanner = () => {
  return (
    <div className='relative mt-24'>
      ...
      <div className='absolute inset-0 flex flex-col items-center md:items-end md:justify-center pt-16 md:pt-0 md:pr-36'>
        <div>
            ...
            {features.map((feature, index)=> (
                <div key={index} className='flex items-center gap-4 mt-3'>
                    ...
                    <div>
                        ...
                        <p className='text-gray-500/70 text-xs md:text-sm mt-0.5'>{feature.description}</p>
                    </div>
                </div>
            ))}
        </div>
